...
## News
- [x] [2024.11.26] 🔥🔥 We release the code to use TrafficLLM to generate pcap files of packets with [Scapy](https://scapy.net/). Go to [tutorials](https://github.com/TrafficLLMv1/TrafficLLM/tree/master/tutorials) for more details.
